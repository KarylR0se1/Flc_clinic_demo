...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\Xampp\htdocs\flc-clinic\public\storage' => 'string',
...
'filesystems.disks.s3.report','filesystems.links.C:\\Xampp\\htdocs\\flc-clinic\\public\\storage','logging.default','logging.deprecations.channel','logging.deprecations.trace',
...
'permission.cache.expiration_time','permission.cache.key','permission.cache.store','ide-helper.filename','ide-helper.models_filename',
...
'web','api',);
        registerArgumentsSet('routes', 'login','login.submit','logout','register','password.request','password.email','password.reset','password.update',
'password.confirm','verification.notice','verification.verify','verification.resend',
'home','terms','custom.verify','redirect.by.role','profile.show',
'profile.edit','profile.update','password.change','password.update','admin.dashboard',
'admin.appointments.index','admin.appointments.updateStatus','admin.appointments.show','admin.patients.index','admin.patients.create',
'admin.patients.store','admin.records.index','admin.records.create','admin.records.store','admin.records.show',
'admin.records.print','admin.doctors.index','admin.doctors.create','admin.doctors.store','admin.vitals.create',
'admin.vitals.store','doctor.dashboard','doctor.schedule','doctor.schedule.update','doctor.',
'doctor.records.index','doctor.records.show','doctor.records.update','doctor.records.store','doctor.reminders',
'patient.dashboard','patient.reminders','patient.profile','patient.profile.store','patient.profile.edit',
'patient.profile.update','appointments.create','appointments.history','appointments.store','appointments.cancel',
'appointments.reschedule','appointments.updateReschedule','patient.register','register.patient','doctor.laboratory.requests',
'laboratory.create','laboratory.create','laboratory.store','laboratory.index','laboratory.show',
'laboratory.update','laboratory.patientRequests','laboratory.attachResult','notifications.markAllRead','notifications.fetchUnread',
'patients.storeManual','doctor.records.form','doctor.records.show','doctor.records.update','appointments.show',
'admin.appointments.triggerReminders','notifications.fetchUnread','admin.patients.storeManual','storage.local',);
        registerArgumentsSet('views', 
'Admin.Appointment','Admin.Appointments.index','Admin.Appointments.show','Admin.Doctors.create','Admin.Doctors.index',
'Admin.Patients.create','Admin.Patients.index','Admin.Patients.show','Admin.Records.create','Admin.Records.index',
'Admin.Records.print','Admin.Records.show','Admin.Vitals.create','Admin.dashboard','Appointments.create',
'Appointments.history','Appointments.reminders','Appointments.reschedule','Appointments.show_reminders','Laboratory.index',
'Laboratory.show','auth.confirm-password','auth.forgot-password','auth.login','auth.passwords.confirm',
'auth.passwords.email','auth.passwords.reset','auth.register','auth.register-doctor','auth.register-patient',
'auth.reset-password','auth.verify','auth.verify-email','components.application-logo','components.auth-session-status',
...
'components.sidebar','components.sidebar.patient','components.text-input','dashboard','doctor.dashboard',
'doctor.records.form','doctor.records.index','doctor.records.show','doctor.schedule','emails.appointment_reminder',
'emails.verify-account','emails.verify-email','home','layouts.app','layouts.guest',
'patient.dashboard','profile.change_password','profile.edit','profile.partials.delete-user-form','profile.partials.update-password-form',
'profile.partials.update-profile-information-form','profile.show','terms','welcome','laravel-exceptions-renderer::components.card',
...
'C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.failed','C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.password','C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.throttle','C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.previous','C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.next',
'C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.reset','C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.sent','C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.throttled','C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.token','C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.user',
'C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted','C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted_if','C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.active_url','C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after','C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after_or_equal',
'C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha','C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_dash','C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_num','C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.any_of','C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.array',
'C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ascii','C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before','C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before_or_equal','C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.array','C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.file',
'C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.numeric','C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.string','C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.boolean','C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.can','C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.confirmed',
'C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.contains','C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.current_password','C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date','C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_equals','C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_format',
'C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.decimal','C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined','C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined_if','C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.different','C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits',
'C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits_between','C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.dimensions','C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.distinct','C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_end_with','C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_start_with',
'C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.email','C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ends_with','C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.enum','C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.exists','C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.extensions',
'C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.file','C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.filled','C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.array','C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.file','C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.numeric',
'C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.string','C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.array','C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.file','C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.numeric','C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.string',
'C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.hex_color','C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.image','C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in','C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array','C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array_keys',
'C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.integer','C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ip','C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv4','C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv6','C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.json',
'C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.list','C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lowercase','C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.array','C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.file','C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.numeric',
'C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.string','C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.array','C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.file','C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.numeric','C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.string',
'C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mac_address','C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.array','C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.file','C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.numeric','C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.string',
'C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max_digits','C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimes','C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimetypes','C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.array','C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.file',
'C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.numeric','C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.string','C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min_digits','C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing','C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_if',
'C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_unless','C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with','C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with_all','C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.multiple_of','C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_in',
'C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_regex','C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.numeric','C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.letters','C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.mixed','C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.numbers',
'C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.symbols','C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.uncompromised','C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present','C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_if','C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_unless',
'C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with','C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with_all','C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited','C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if','C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_accepted',
'C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_declined','C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_unless','C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibits','C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.regex','C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required',
'C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_array_keys','C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if','C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_accepted','C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_declined','C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_unless',
'C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with','C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with_all','C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without','C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without_all','C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.same',
'C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.array','C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.file','C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.numeric','C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.string','C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.starts_with',
'C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.string','C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.timezone','C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.unique','C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uploaded','C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uppercase',
'C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.url','C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ulid','C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uuid','C:.Xampp.htdocs.flc-clinic.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.custom.attribute-name.rule-name',);
